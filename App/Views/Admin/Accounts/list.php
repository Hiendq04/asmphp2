<div class="right-sitebar container content-admin">
    <h2 class="py-4 title-admin">Thông tin tài khoản</h2>
    <form class="input-group mb-3" method="post">
        <input type="text" class="form-control" name="keyword" placeholder="Nhập tên tài khoản muốn tìm kiếm"
        ...
        <table class="table-hung table_account">
            ...
            <tbody id="body-listUser">
                ...
                <tr class="trListAccount">
                    ...
                    <td><a style="text-decoration: none;color: black;" href="<?= $adminUrl . "accounts/accountInfo&id=".$acc['id'] ?>"><?php echo $acc['user_name'] ?></a></td>
                    <td><?php echo $acc['email'] ?></td>
                    <td hidden class="roleId"><?php echo $acc['role'] ?></td>
                    <td>
                        <?php
                    ...
                    <td hidden class="statusId"><?php echo $acc['status'] ?></td>
                    <td>
                        <a class="btn btn-info" href="<?= $adminUrl . "accounts/update&id=" . $acc['id'] ?>">Sửa</a> 
                        <a class="btn btn-danger" onclick="return confirm('Bạn chắc chắn muốn xóa chứ ?')"
                            href="<?= $adminUrl . "accounts/delete&id=" . $acc['id'] ?>">Xóa</a>
                    </td>
